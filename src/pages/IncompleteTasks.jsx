...
import styles from "./IncompleteTasks.module.css";
...
function IncompleteTasks() {
  ...
  return (
    <div style={{ display: "flex", width: "100%", height: "100%", gap: "8px", padding: "5px" }}>
      {/* Left Section (List of Incomplete todos) */}
      <div className={styles.left}>
        <h2 style={{ textAlign: "left", paddingLeft: "10px",color:"#FF6767" }}>Incomplete Tasks</h2>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingBottom: "20px" }}>
          ...
          {completedTodos.length > 0 ? (
            ...
            >
              <p style={{ fontWeight: "600", fontSize: "20px" ,marginTop:"40px"}}>No Incomplete Tasks Available</p>
            </div>
          )}
        </div>
      </div>
